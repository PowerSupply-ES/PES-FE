...
const ProblemItem = (props) => {
    ...
    return (_jsx(StyledListItem, { state: state, children: _jsxs("div", { className: "container", children: [_jsx("div", { className: "problem_id", onClick: () => {
                        goToProb(props.answerId);
                    }, children: props.pid }), _jsx("div", { className: "problem_title", onClick: () => {
                        goToProb(props.answerId);
                    }, children: props.ptitle }), _jsxs("div", { className: "grade", children: ["\uC810\uC218 ", props.grade] }), _jsx("button", { className: "button", onClick: () => navigate(`/solution/${props.pid}`), children: "\uD480\uC774\uBCF4\uAE30" })] }) }));
};
