...
const ProbCode = ({ FstHandler, SecHandler, code, qnA, setCode, }) => {
    return (_jsxs("div", { className: "code_question_container", children: [_jsx("div", { className: "code_container", children: _jsx(CodeEditor, { onChange: setCode, readOnly: true, code: code }) }), _jsx("div", { className: "question_container", children: qnA.answerState === "question" ? ( // 기존 : !qnA.answerState || !qnA.answerSec
