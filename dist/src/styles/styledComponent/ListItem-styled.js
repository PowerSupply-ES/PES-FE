...
export const StyledListItem = styled.div `
  .container {
    ...
    background-color: ${(props) => props.state === "locked"
    ? "#DEDEDE"
    : props.state === "comment"
  ...
  .problem_id {
    width: 100px;
    height: 34px;
    color: ${(props) => props.state === "success"
    ? "#04CA00"
    : props.state === "fail"
        ? "#FF8412"
        : "black"};
  ...
  .button {
    ...
    color: ${(props) => props.state === "success" || props.state === "fail"
    ? "white"
    : "#56565692"};

    background-color: ${(props) => props.state === "success"
    ? "rgba(109, 99, 228, 0.8)"
    : props.state === "fail"
    ...
    text-align: center;
    border: ${(props) => props.state === "success" || props.state === "fail"
    ? "none"
    : props.state === null
        ? "#d6d6d6cc"
        : "2px solid #DEDEDE"};
