(self["webpackChunkpes_fe"] = self["webpackChunkpes_fe"] || []).push([["src_libs_ace_js"],{
...
(function () {
...
}), ace.define("ace/lib/default_english_messages", ["require", "exports", "module"], function (e, t, n) {
  var r = {
...
}), ace.define("ace/lib/app_config", ["require", "exports", "module", "ace/lib/oop", "ace/lib/event_emitter", "ace/lib/report_error", "ace/lib/default_english_messages"], function (e, t, n) {
  "no use strict";
  ...
  var r = e("./oop"),
    ...
    c = function () {
      ...
      return e.prototype.defineOptions = function (e, t, n) {
        ...
        f[e] || (a("No message found for the key '" + e + "' in the provided messages, trying to find a translation for the default string '" + t + "'."), f[t] || a("No message found for the default string '" + t + "' in the provided messages. Falling back to the default English message."));
        var r = f[e] || f[t] || t;
  ...
  t.get = function (e) {
    ...
    if (u.hasOwnProperty(e)) u[e] = t;else if (this.setDefaultValue("", e, t) == 0) throw new Error("Unknown config key: " + e);
  ...
  t.setLoader = function (e) {
    ...
    var r;
    if (Array.isArray(e)) var s = e[0],
      o = e[1];else if (typeof e == "string") var o = e;
    var u = function (e) {
  ...
  function s(t) {
    ...
    r.set("packaged", t || e.packaged || n.packaged || i.define && __webpack_require__.amdD.packaged);
    var s = {},
      u = "",
  ...
  n.exports = function (t) {
    r.init = s, r.$require = e, t.require = e,  true && (t.define = __webpack_require__.amdD);
  };
  ...
  y = function (e, t) {
    ...
    function nt(e, t, n) {
      ...
      var s = function (e) {
        ...
        var r = n.selectionStart,
          ...
          o = null,
          u = 0;
        if (r == 0) o = p.up;else if (r == 1) o = p.home;else if (s > k && N[s] == "\n") o = p.end;else if (r < C && N[r - 1] == " ") o = p.left, u = d.option;else if (r < C || r == C && k != C && r == s) o = p.left;else if (s > k && N.slice(0, s).split("\n").length > 2) o = p.down;else if (s > k && N[s - 1] == " ") o = p.right, u = d.option;else if (s > k || s == k && k != C && r == s) o = p.right;
        r !== s && (u |= d.shift);
        if (o) {
    ...
    this.setNumberOfExtraLines = function (e) {
      ...
      if (e.setLabel) {
        n.setAttribute("aria-roledescription", i("text-input.aria-roledescription", "editor"));
        var r = "";
        t.$textInputAriaLabel && (r += "".concat(t.$textInputAriaLabel, ", "));
        if (t.session) {
          var s = t.session.selection.cursor.row;
          r += i("text-input.aria-label", "Cursor at row $0", [s + 1]);
        }
      ...
      H = v ? function (e) {
        ...
        if (t.session) {
          var s = t.selection,
            o = s.getRange(),
            u = s.cursor.row;
          if (u === O + 1) A = O + 1, O = A + 2 * M;else if (u === A - 1) O = A - 1, A = O - 2 * M;else if (u < A - 1 || u > O + 1) A = u > M ? u - M : 0, O = u > M ? u + M : 2 * M;
          var a = [];
    ...
    var $ = function (e) {
      ...
      J = function () {
        ...
        if (x) return Q();
        if (w.useTextareaForIME) t.onCompositionUpdate(n.value);else {
          var e = n.value;
  ...
  t.HoverTooltip = p;
}), ace.define("ace/mouse/default_gutter_handler", ["require", "exports", "module", "ace/lib/dom", "ace/lib/event", "ace/tooltip", "ace/config", "ace/lib/lang"], function (e, t, n) {
  "use strict";
  ...
  function l(e) {
    function a() {
      ...
      if (!r.isOpen) return;
      t.on("mousewheel", f);
      if (e.$tooltipFollowsMouse) l(u);else {
        var c = u.getGutterRow(),
          h = n.$lines.get(c);
        if (h) {
    ...
    e.editor.setDefaultHandler("guttermousemove", function (t) {
      ...
      r.isOpen && e.$tooltipFollowsMouse && l(t), u = t;
      if (i) return;
    ...
    }, t), t.on("changeSession", f), t.on("input", f);
  }
  var r = this && this.__extends || function () {
      var e = function (t, n) {
        return e = Object.setPrototypeOf || {
  ...
  var c = function (e) {
    ...
    return r(t, e), t.prototype.setPosition = function (e, t) {
      ...
      s.removeChildren(b), v.error.forEach(function (e) {
        ...
        return b.appendChild(e);
      }), b.setAttribute("aria-live", "polite"), this.isOpen || (this.setTheme(this.editor.renderer.theme), this.setClassName("ace_gutter-tooltip")), this.show(), this.editor._signal("showGutterTooltip", this);
  ...
  function a() {
    this.getFoldAt = function (e, t, n) {
      ...
      if (s && /^comment|string/.test(u)) {
        ...
        return f.end.row = i.getCurrentTokenRow(), f.end.column = i.getCurrentTokenColumn(), f;
      }
  ...
  function s() {
    this.findMatchingBracket = function (e, t) {
      ...
      var t = e.getCurrentToken(),
        n = !1,
        r = !1;
      if (t && t.type.indexOf("tag-name") === -1) do r ? t = e.stepBackward() : t = e.stepForward(), t && (t.value === "/>" ? r = !0 : t.type.indexOf("tag-name") !== -1 && (n = !0)); while (t && !n);
      return t;
      ...
      do {
        ...
        if (t) {
          ...
          if (t.type.indexOf("tag-name") !== -1) {
            r = t.value;
            if (s === r) if (n.value === "<") o++;else if (n.value === "</") {
              o--;
              if (o < 0) {
                e.stepBackward();
      ...
      do {
        ...
        if (t) if (t.type.indexOf("tag-name") !== -1) {
  ...
  var r = e("./lib/oop"),
    ...
    v = function () {
      function e(t, n) {
        this.doc, this.$breakpoints = [], this.$decorations = [], this.$frontMarkers = {}, this.$backMarkers = {}, this.$markerId = 1, this.$undoSelect = !0, this.$foldData = [], this.id = "session" + ++e.$uid, this.$foldData.toString = function () {
          return this.join("\n");
        ...
        this.setDocument(t), this.selection = new a(this), this.$bidiHandler = new s(this), o.resetOptions(this), this.setMode(n), o._signal("session", this), this.destroyed = !1;
      }
      return e.prototype.setDocument = function (e) {
        ...
        for (var i = 0; i < e.length; i++) {
          ...
          } else s == 32 ? n.push(E) : s > 39 && s < 48 || s > 57 && s < 64 ? n.push(w) : s >= 4352 && T(s) ? n.push(m, g) : n.push(m);
        }
        return n;
  ...
  v.$uid = 0, v.prototype.$modes = o.$modes, v.prototype.getValue = v.prototype.toString, v.prototype.$defaultUndoManager = {
    undo: function () {},
    redo: function () {},
    hasUndo: function () {},
    hasRedo: function () {},
    ...
    min: null,
    max: null
  }, v.prototype.lineWidgets = null, v.prototype.isFullWidth = T, r.implement(v.prototype, u);
  var m = 1,
    g = 2,
    y = 3,
    b = 4,
    ...
    S = 11,
    x = 12;
  e("./edit_session/folding").Folding.call(v.prototype), e("./edit_session/bracket_match").BracketMatch.call(v.prototype), o.defineOptions(v.prototype, "session", {
    wrap: {
      set: function (e) {
    ...
    o = function () {
      ...
      return e.prototype.set = function (e) {
        ...
        if (t.$isMultiLine) var h = n.length,
          ...
          };else if (i) var p = function (t, i, s) {
          var u = e.getLine(t),
            a = [],
            f,
            l = 0;
  ...
  var r = this && this.__extends || function () {
    ...
    u = function () {
      ...
      return e.prototype.$init = function (e, t, n) {
        ...
        var r = this.commandKeyBinding,
          i;
        if (!t) delete r[e];else if (!r[e] || this.$singleCommand) r[e] = t;else {
        ...
        if (s) if (s == "chainKeys" || s[s.length - 1] == "chainKeys") return e.$keyChain = e.$keyChain || i, {
          command: "null"
        };
  ...
  var r = this && this.__extends || function () {
    ...
    u = function (e) {
      ...
      return r(t, e), t.prototype.exec = function (e, t, n) {
        ...
        if (!this.canExecute(e, t)) return !1;
        var i = {
          editor: t,
          command: e,
          args: n
      ...
      return e.prototype.addListener = function () {
        ...
        if (e.keyCode === r.enter || e.keyCode === r.space) {
          ...
          switch (this.activeLane) {
            ...
            case "annotation":
              ...
              s.left = i.right + "px", s.top = i.bottom + "px", this.annotationTooltip.showTooltip(this.$rowIndexToRow(this.activeRowIndex));
          }
          return;
        }
        ...
        switch (e) {
          ...
          case "fold":
            ...
            if (n == null) break;
            this.activeLane = "fold", this.$blurAnnotation(this.activeRowIndex), this.activeRowIndex = n, this.$focusFoldWidget(this.activeRowIndex);
        }
        return;
  ...
  var r = this && this.__values || function (e) {
    ...
    N = function () {
      ...
      return e.prototype.$initOperationListeners = function () {
        ...
        this.session.widgetManager || (this.session.widgetManager = new w(this.session), this.session.widgetManager.attach(this)), this.renderer.setGhostText(e, t);
    ...
    placeholder: {
      set: function (e) {
        this.$updatePlaceholder || (this.$updatePlaceholder = function () {
          ...
          if (e && this.renderer.placeholderNode) this.renderer.off("afterRender", this.$updatePlaceholder), s.removeCssClass(this.container, "ace_hasPlaceholder"), this.renderer.placeholderNode.remove(), this.renderer.placeholderNode = null;else if (!e && !this.renderer.placeholderNode) {
  ...
  var r = e("../lib/dom"),
    ...
    f = function () {
      ...
      return e.prototype.setSession = function (e) {
        ...
        this.$highlightGutterLine && (i == this.$cursorRow || n && i < this.$cursorRow && i >= g && this.$cursorRow <= n.end.row) && (b += "ace_gutter-active-line ", this.$cursorCell != e && (this.$cursorCell && (this.$cursorCell.element.className = this.$cursorCell.element.className.replace("ace_gutter-active-line ", "")), this.$cursorCell = e)), p[i] && (b += p[i]), d[i] && (b += d[i]), this.$annotations[i] && i !== g && (b += this.$annotations[i].className);
        if (m) {
          var S = m[i];
        ...
        if (S) {
          ...
          if (T) {
            ...
            for (var k = i + 1; k <= n.end.row; k++) {
              ...
              this.$annotations[k].className === " ace_security" ? (C = !0, N = " ace_security_fold") : this.$annotations[k].className === " ace_warning" && N !== " ace_security_fold" && (C = !0, N = " ace_warning_fold");
            }
            b += N;
          } else x += " ace_open";
          f.className != x && (f.className = x), r.setStyle(f.style, "height", y), r.setStyle(f.style, "display", "inline-block"), f.setAttribute("role", "button"), f.setAttribute("tabindex", "-1");
          var L = o.getFoldWidgetRange(i);
          L ? f.setAttribute("aria-label", a("gutter.code-folding.range.aria-label", "Toggle code folding, rows $0 through $1", [L.start.row + 1, L.end.row + 1])) : n ? f.setAttribute("aria-label", a("gutter.code-folding.closed.aria-label", "Toggle code folding, rows $0 through $1", [n.start.row + 1, n.end.row + 1])) : f.setAttribute("aria-label", a("gutter.code-folding.open.aria-label", "Toggle code folding, row $0", [i + 1])), T ? (f.setAttribute("aria-expanded", "false"), f.setAttribute("title", a("gutter.code-folding.closed.title", "Unfold code"))) : (f.setAttribute("aria-expanded", "true"), f.setAttribute("title", a("gutter.code-folding.open.title", "Fold code")));
        ...
        if (C && this.$showFoldedAnnotations) {
          l.className = "ace_gutter_annotation", c.className = w, c.className += N, r.setStyle(c.style, "height", y), r.setStyle(l.style, "display", "block"), r.setStyle(l.style, "height", y);
          var A;
          switch (N) {
            case " ace_error_fold":
              A = a("gutter.annotation.aria-label.error", "Error, read annotations row $0", [E]);
              break;
            case " ace_security_fold":
              A = a("gutter.annotation.aria-label.security", "Security finding, read annotations row $0", [E]);
              break;
            case " ace_warning_fold":
              A = a("gutter.annotation.aria-label.warning", "Warning, read annotations row $0", [E]);
          }
          l.setAttribute("aria-label", A), l.setAttribute("tabindex", "-1"), l.setAttribute("role", "button");
        } else if (this.$annotations[i]) {
          l.className = "ace_gutter_annotation", c.className = w, this.$useSvgGutterIcons ? c.className += this.$annotations[i].className : s.classList.add(this.$annotations[i].className.replace(" ", "")), r.setStyle(c.style, "height", y), r.setStyle(l.style, "display", "block"), r.setStyle(l.style, "height", y);
          var A;
          switch (this.$annotations[i].className) {
            ...
            case " ace_warning":
              ...
              break;
            case " ace_info":
              A = a("gutter.annotation.aria-label.info", "Info, read annotations row $0", [E]);
              break;
            case " ace_hint":
              A = a("gutter.annotation.aria-label.hint", "Suggestion, read annotations row $0", [E]);
          }
          l.setAttribute("aria-label", A), l.setAttribute("tabindex", "-1"), l.setAttribute("role", "button");
        } else r.setStyle(l.style, "display", "none"), l.removeAttribute("aria-label"), l.removeAttribute("role"), l.setAttribute("tabindex", "0");
        return E !== u.data && (u.data = E), s.className != b && (s.className = b), r.setStyle(e.element.style, "height", this.$lines.computeLineHeight(i, t, o) + "px"), r.setStyle(e.element.style, "top", this.$lines.computeLineTop(i, t, o) + "px"), e.text = E, l.style.display === "none" && f.style.display === "none" ? e.element.setAttribute("aria-hidden", !0) : e.element.setAttribute("aria-hidden", !1), e;
      }, e.prototype.setHighlightGutterLine = function (e) {
  ...
  var r = e("../lib/oop"),
    ...
    l = function () {
      ...
      return e.prototype.$updateEolChar = function () {
        ...
        if (t !== 0) if (this.$highlightIndentGuideMarker.dir === 1) for (var n = 0; n < e.length; n++) {
          var r = e[n];
  ...
  var S = function () {
    ...
    return e.prototype.updateCharacterSize = function () {
      ...
      var s = {
        ...
        o = i.getTokens(n);
      if (r == null || !o.length) o.push(s);else {
        var u = 0;
  ...
  function a(e, t, n) {
    ...
    if (!o || !n) return;
    if (o.row === t) {
      do o = r[i += n]; while (o && o.row === t);
      if (!o) return r.slice();
    }
    var a = [];
    t = o.row;
    do a[n < 0 ? "unshift" : "push"](o), o = r[i += n]; while (o && o.row == t);
    return a.length && a;
  }
  ...
  t.showErrorMarker = function (e, t) {
    ...
    if (l) {
      var h = l[0];
      s.column = (h.pos && typeof h.column != "number" ? h.pos.sc : h.column) || 0, s.row = h.row, c = e.renderer.$gutterLayer.$annotations[s.row];
    } else {
      if (f) return;
      c = {
        displayText: [o("error-marker.good-state", "Looks good!")],
        className: "ace_ok"
      };
    }
    ...
    v.style.left = m + e.renderer.gutterWidth - 5 + "px", p.el.className = "error_widget_wrapper", d.className = "error_widget " + c.className, c.displayText.forEach(function (e, t) {
      d.appendChild(i.createTextNode(e)), t < c.displayText.length - 1 && d.appendChild(i.createElement("br"));
    }), d.appendChild(i.createElement("div"));
    var g = function (e, t, n) {
      if (t === 0 && (n === "esc" || n === "return")) return p.destroy(), {
        command: "null"
      };
    };
    p.destroy = function () {
      if (e.$mouseHandler.isMousePressed) return;
      e.keyBinding.removeKeyboardHandler(g), n.widgetManager.removeLineWidget(p), e.off("changeSelection", p.destroy), e.off("changeSession", p.destroy), e.off("mouseup", p.destroy), e.off("change", p.destroy);
    }, e.keyBinding.addKeyboardHandler(g), e.on("changeSelection", p.destroy), e.on("changeSession", p.destroy), e.on("mouseup", p.destroy), e.on("change", p.destroy), e.session.widgetManager.addLineWidget(p), p.el.onmousedown = e.focus.bind(e), e.renderer.scrollCursorIntoView(null, .5, {
  ...
  }, t.Range = i, t.Editor = s, t.EditSession = o, t.UndoManager = u, t.VirtualRenderer = a, t.version = t.config.version;
});
(function () {
...
//# sourceMappingURL=src_libs_ace_js.de136082187092afbd63.js.map