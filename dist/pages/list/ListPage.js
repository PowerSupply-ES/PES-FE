...
const ListPage = () => {
    ...
    return (_jsxs("div", { children: [_jsx(AdPart, {}), _jsxs(StyledListPage, { style: { width: "100%", display: "flex", justifyContent: "center" }, children: [_jsxs("div", { className: "list_container", children: [_jsx("div", { className: "container_header", children: "\uD83D\uDDA5\uFE0F \uBB38\uC81C" }), _jsx("div", { className: "problem_wrapper", children: list.map((problem) => (_jsx(ProblemItem, { pid: problem.problemId, ptitle: problem.problemTitle, grade: problem.problemScore, answerId: problem.answerId, state: problem.answerState }, problem.problemId))) })] }), _jsxs("div", { className: "ranking_container", children: [_jsx("div", { className: "container_header", children: "\uD83C\uDFC6 \uB7AD\uD0B9" }), _jsxs("div", { className: "student_container", children: [_jsx(Button, { className: `student_button ${selectedOption === "junior" ? "student_button_active" : ""}`, color: "primary", size: "large", variant: juniorButtonVariant, onClick: () => handleOption("junior"), children: "\uC2E0\uC785\uC0DD" }), _jsx(Button, { className: `student_button ${selectedOption === "senior" ? "student_button_active" : ""}`, color: "primary", size: "large", variant: seniorButtonVariant, onClick: () => handleOption("senior"), children: "\uC7AC\uD559\uC0DD" })] }), selectedOption === "junior" && _jsx(JuniorRank, {}), selectedOption === "senior" && _jsx(SeniorRank, {})] })] })] }));
};
