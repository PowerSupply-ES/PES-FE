...
// import {img_probList, img_solving, img_pass, img_pass_feed, img_fail, img_fail_feed, img_solvingList} from "assets/images";
...
//         <h2>
//           PES는<br></br> 3가지 핵심 기능을 제공합니다
//         </h2>
//         <div className="content_menual">
//           <div className="wrap_container">
//             <div className="wrap">
//               <div className="keyword">컴파일</div>
//               <div>
//                 신입생은 C언어로<br></br>문제를 푼다.
//               </div>
//             </div>
//           </div>
//           <div className="wrap_container">
//             <div className="wrap">
//               <div className="keyword">질문과 답변</div>
//               <div>
//                 신입생은 문제에 대한 <br></br>2가지 질문에 답변을 한다.
//               </div>
//             </div>
//           </div>
//           <div className="wrap_container">
//             <div className="wrap">
//               <div className="keyword">피드백</div>
//               <div>
//                 재학생은 신입생의 코드와 답변에<br></br>피드백을 한다.
//               </div>
//             </div>
//           </div>
//         </div>
...
//           <h2>풀이Step.</h2>문제에 대한 예시를 보고<br></br>
//           우측에 코드를 입력하여 문제풀이해요
//         </div>
//         <div className="img_container">
...
//         <div className="info">그럼, 시작해보세요!</div>
