...
export {default as img_backImage_right} from './backImg_right.png';
export {default as img_backImage} from './backImg.png';
export {default as img_main_2} from './main_2.webp';
export {default as img_main_3} from './main_3.webp';
export {default as img_main_4} from './main_4.png';
export {default as img_sign_logo} from './sign_logo.png';
