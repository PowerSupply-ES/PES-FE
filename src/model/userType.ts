...
export type SetMemDetail = React.Dispatch<
  React.SetStateAction<MemberDetail | null>
>;

// 내 memberData 상태관리 HOOK setMemberData 타입
export type SetMyDetail = React.Dispatch<
  React.SetStateAction<MemberDetail | undefined>
>;
...
export type SetUserDetail = React.Dispatch<
  React.SetStateAction<UserDetail | null>
>;
